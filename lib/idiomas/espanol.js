...
//AVISOS DE MENSAJE
const smsAvisoRG = () => { return `╰⊱✅⊱ *الامـر شـغـال يـسـطـا* ⊱✅⊱╮\n\n` } 
const smsAvisoAG = () => { return `╰⊱⚠️⊱ *تـحـذيـر يـسـطـا* ⊱⚠️⊱╮\n\n` }
const smsAvisoIIG = () => { return `╰⊱❕⊱ *مـعـلـومـه هـتـفـيـدك يـسـطـا* ⊱❕⊱╮\n\n` }
const smsAvisoFG = () => { return `╰⊱❌⊱ *الامـر عـمـل ايـرور* ⊱❌⊱╮\n\n` }
const smsAvisoMG = () => { return `╰⊱❗️⊱ *بـتـسـتـخـدم الامـر غـلـط يـعـم* ⊱❗️⊱╮\n\n` }
const smsAvisoEEG = () => { return `╰⊱📩⊱ *الابـلاغ يـسـطـا* ⊱📩⊱╮\n\n` }
const smsAvisoEG = () => { return `╰⊱💚⊱ *نـجـح الامـر يـسـطـا* ⊱💚⊱╮\n\n` }
